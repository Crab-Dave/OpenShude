...
(async () => {
  ...
  assert.match(await admin.locator('#page-content').textContent(), /同一个组同时提供权限和年级范围/);
  ...
  console.log('Browser checks passed: cards, permissions workspace, group-admin mode switching, scoped menus, dormitories, export, and mobile layouts.');
})().catch(async (error) => {
