...
(async () => {
  ...
  await activityGroupSearch.fill('2026003');
  assert.equal(await desktop.locator('#activity-group-form .candidate:visible').count(), 1);
  assert.match(await desktop.locator('#activity-group-form .candidate:visible').textContent(), /苏晴.*2025级.*工商管理/s);
  ...
  await selectionGroupSearch.fill('2026003');
  assert.equal(await admin.locator('#selection-group-candidates .candidate:visible').count(), 1);
  assert.match(await admin.locator('#selection-group-candidates .candidate:visible').textContent(), /苏晴.*工商管理.*2026003/s);
