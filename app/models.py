...
class Conversation(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    student_a_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"))
    student_b_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"))
...
class AuditLog(Base):
    ...
    grant_group_id: Mapped[int | None] = mapped_column(ForeignKey("admin_groups.id"))
...
class DormitoryRoundParticipant(Base):
    ...
    round_id: Mapped[int] = mapped_column(
        ForeignKey("dormitory_selection_rounds.id", ondelete="CASCADE"), primary_key=True
    )
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"), primary_key=True)
...
class Dormitory(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    selection_round_id: Mapped[int] = mapped_column(ForeignKey("dormitory_selection_rounds.id"))
    ...
    management_grade_id: Mapped[int | None] = mapped_column(ForeignKey("grades.id"))
...
class DormitoryResultSnapshot(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    selection_round_id: Mapped[int] = mapped_column(ForeignKey("dormitory_selection_rounds.id", ondelete="CASCADE"))
...
class AdminGroupMember(Base):
    ...
    group_id: Mapped[int] = mapped_column(ForeignKey("admin_groups.id", ondelete="CASCADE"), primary_key=True)
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"), primary_key=True)
    created_by: Mapped[int | None] = mapped_column(ForeignKey("users.id"))
    created_at: Mapped[str] = mapped_column(Text)
